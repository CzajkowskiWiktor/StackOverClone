...
<body>
	<div class="add_question" align="center">
		<h1 class="add_question-title">Edit Answer</h1>
		<form class="add_question__form" action="/../DatabaseServlets/editAnswer" method="post">
			<div class="add_question__form-box">
				<label for="question_text">New Answer text:</label><br>
				<input id="questionID" name="questionID" type="hidden" value="${param.id}">
			  	<textarea id="question_text" name="question_text" placeholder="Enter your new answer text"></textarea><br>
			</div>
		  	<br>
