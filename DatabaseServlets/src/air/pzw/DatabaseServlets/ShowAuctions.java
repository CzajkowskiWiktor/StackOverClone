...
/**
 * Servlet implementation class ShowAuctions
 */
@WebServlet("/ShowAuctions")
public class ShowAuctions extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String resultString="";
            if (id==null) {
            	if (stmt.execute("SELECT * FROM AUCTIONSONLINE")) {
            	...
            	if (stmt.execute("SELECT * FROM AUCTIONSONLINE WHERE IDU="+id)) {
                    rs = stmt.getResultSet();
                    resultString = getHtmlTableFromResultSet(rs);
                }
                else
